...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('myapp_blogpost', (
        ...
        db.send_create_signal('myapp', ['BlogPost'])

        # Adding model 'BlogComment'
        db.create_table('myapp_blogcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ...
            ('belongsTo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myapp.BlogPost'])),
        ))
        db.send_create_signal('myapp', ['BlogComment'])


    def backwards(self, orm):
        # Deleting model 'BlogPost'
        db.delete_table('myapp_blogpost')

        # Deleting model 'BlogComment'
        db.delete_table('myapp_blogcomment')
    ...
    models = {
        ...
        'myapp.blogcomment': {
            ...
            'belongsTo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['myapp.BlogPost']"}),
